...
#ifndef BOXOSDK_SWIFT_H
#define BOXOSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BoxoSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class Miniapp;
@class MiniappData;
SWIFT_CLASS_NAMED("Boxo")
@interface Boxo : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) Boxo * _Nonnull shared;)
+ (Boxo * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_ENUM_FWD_DECL(NSInteger, Theme)
...
SWIFT_ENUM_FWD_DECL(NSInteger, PageAnimation)
@class UIImage;
